...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/floral-glitter-59a5
```

A live public deployment of this template is available at [https://floral-glitter-59a5.templates.workers.dev](https://floral-glitter-59a5.templates.workers.dev)
